---
task_id: CT-20260901-night-shift-sleep-management
title: 夜勤・交代勤務の睡眠対策｜シフトと仮眠環境から見直す実務
...
draft_reference: /Users/dmmac/Library/Mobile Documents/iCloud~md~obsidian/Documents/MyBrain/00-Projects/kdk-wordpress/content/articles/night-shift-sleep-management.html
exact_version: 2026-09-01-v6
exact_version_sha256: e7368a4d94aefbbf23db21741b0b6d6c4499496d143866d684799c53d7e64a49
approval_owner: 宮部 大輔
approval_evidence:
physician_approval:
publication_url: https://kdkconslt-sngyouijm.com/night-shift-sleep-management/
published_verified_at: 2026-09-01T15:23:56+09:00
---
...
- 夜勤・交代勤務の睡眠課題を個人の努力で終わらせず、勤務設計と就業配慮の相談へつなぐ。

## Audience and action

- Audience: 夜勤・交代勤務を持つ企業の人事・安全衛生担当者
- Main question or job: シフト、休息、仮眠、相談導線を会社としてどう整えるか
...
- Current product or service state: 継続的な睡眠・勤務リスクの専門補完はKIDUKI Basic。復職・就業制限の個別案件は単発/Pack。非復職の制度レビューは正式SKU確定まで契約導線に数えない。
- Approved terminology: 勤務設計、眠気リスク、就業上の配慮、再評価
...
|---|---|---|---|
| /Users/dmmac/Library/Mobile Documents/iCloud~md~obsidian/Documents/MyBrain/00-Projects/kdk-wordpress/content/articles/night-shift-sleep-management.html | 2026-09-01 | 公開/予約版の本文、CTA、記事内根拠 | 検索成果、owner/physician approval |
...
- CTA or next action: 既存体制への追加支援を相談する
...
|---|---|---|---|---|---|
| High | 記事末CTA | 公開版は全記事共通CTAで、夜勤・交代勤務の検索意図と最初の商品が一致しない | article-plan.json / service/komon | Basicを主着地、復職・就業制限の個別案件に限り単発/Packへ分岐するexact CTAへ修正 | accepted / repaired locally |
...
- Local artifact: `/Users/dmmac/Library/Mobile Documents/iCloud~md~obsidian/Documents/MyBrain/00-Projects/kdk-wordpress/content/articles/night-shift-sleep-management.html`
- Automated checks: `npm run verify:article-plan` と `npm run verify:conversion-tracking` の対象。2026-09-01 20:37 JSTのv6 dry-runはCTAのみ11件 `would_update`、SAS本文を含む1件 `would_update_reviewed_full_body`、`writes: false`。日付経過後の状態検証はWordPress実状態と分ける。
...
- Schedule record: WordPress post 1840、2026-09-01 07:00 JST公開を確認
- Post-publication review record: 7d 2026-09-08T08:00:00+09:00（7pf4iraovdsabhgm7tmjjs3hhg）、28d 2026-09-29T08:20:00+09:00（qg0pnae6aeei9qgup3jj24u500）、90d 2026-11-30T08:50:00+09:00（s9rs87so1u58m09equgpm2kusg）。Google Calendar APIで2026-09-01に確認
- Published verification:
- Measurement source and period:
- Remaining gates: owner/physician approval evidence、Search Consoleのインデックス・検索成果、記事→サービス→問い合わせ→契約の測定
...
| 2026-09-01 | backlog | published | WordPress post 1840 と公開URLを確認。承認証拠、インデックス、検索成果は別途確認 |
| 2026-09-01 | published | owner-review | 公開版を変更せず、CTA exact版 2026-09-01-v1 を作成 |
