---
task_id: CT-20260901-work-restriction-release-management
title: 就業制限を「解除し忘れる」構造と、期限管理の実務
...
draft_reference: /Users/dmmac/Library/Mobile Documents/iCloud~md~obsidian/Documents/MyBrain/00-Projects/kdk-wordpress/content/articles/work-restriction-release-management.html
exact_version: 2026-09-01-v6
exact_version_sha256: 184df82b4d900142035685be2595de6d964524e10a4e2b53c0fd2b61a088c8c3
...
- 就業制限の解除忘れを防ぐ実務を説明し、目前の再評価または継続管理の契約相談へつなぐ。

## Audience and action

- Audience: 就業制限と再評価日を管理する人事・労務担当者
- Main question or job: 期限、継続・変更・解除の判断、過去案件をどう管理するか
- Desired next action: 目前の再評価は `/service/return-to-work-support/`、継続管理は `/service/cloud/` へ進む
- Non-goals: 個人への診断・治療指示、効果保証、特定医療機関への誘導、検索語の機械的反復

## Project truth

- Canonical project guide: ../README.md
- Current product or service state: 1回の再評価は範囲固定の復職・両立支援単発、工程全体はPack、自社継続管理はCASETRA。
- Approved terminology: 就業制限、再評価日、解除条件、会社決定、期限管理
...
|---|---|---|---|
| /Users/dmmac/Library/Mobile Documents/iCloud~md~obsidian/Documents/MyBrain/00-Projects/kdk-wordpress/content/articles/work-restriction-release-management.html | 2026-09-01 | 公開/予約版の本文、CTA、記事内根拠 | 検索成果、owner/physician approval |
...
- CTA or next action: 目前の再評価か継続管理かを相談する
...
|---|---|---|---|---|---|
| High | 記事末CTA | 予約版は全記事共通CTAで、目前の再評価と継続管理を選べない | article-plan.json / service/return-to-work-support / service/cloud | 復職・両立支援を主着地、CASETRAを副着地とするexact CTAへ修正 | accepted / repaired locally |
...
- Local artifact: `/Users/dmmac/Library/Mobile Documents/iCloud~md~obsidian/Documents/MyBrain/00-Projects/kdk-wordpress/content/articles/work-restriction-release-management.html`
...
- Schedule record: WordPress post 1858、2026-10-02 07:00 JST予約を確認
- Post-publication review record: 7d 2026-10-09T08:00:00+09:00（up7u6kgmaih3vdnd4hk9sbjm68）、28d 2026-10-30T08:20:00+09:00（n77jj4eks8gbvgmsippd55d00s）、90d 2026-12-31T08:50:00+09:00（m4as3ni6c41504kt7dao6m3q1k）。Google Calendar APIで2026-09-01に確認
...
| 2026-09-01 | backlog | scheduled | WordPress post 1858、2026-10-02 07:00 JSTを確認。予約は承認証拠ではない |
