---
task_id: CT-20260901-committee-minutes-three-year-retention
title: 衛生委員会の議事録は3年保存｜誰が、いつまでに、どこに残すか
...
draft_reference: /Users/dmmac/Library/Mobile Documents/iCloud~md~obsidian/Documents/MyBrain/00-Projects/kdk-wordpress/content/articles/committee-minutes-three-year-retention.html
exact_version: 2026-09-01-v6
exact_version_sha256: 04f740385260be24f06a86222c8dac50a85841ee718fb4bc93fc3c898653521f
...
- 衛生委員会議事録の作成・周知・保存を、継続運用または証跡管理の相談へつなぐ。

## Audience and action

- Audience: 衛生委員会を運営する人事・総務・衛生管理者
- Main question or job: 誰が、いつまでに、どこへ議事録を残し、担当交代後も追えるようにするか
- Desired next action: 委員会運用は `/service/sangyoui/`、証跡の仕組み化は `/service/cloud/` へ進む
- Non-goals: 個人への診断・治療指示、効果保証、特定医療機関への誘導、検索語の機械的反復

## Project truth

- Canonical project guide: ../README.md
- Current product or service state: 委員会を含む法定・定例業務はKIDUKI Retain。自社運用の証跡管理はCASETRA。
- Approved terminology: 衛生委員会、議事録、周知、3年保存、証跡
...
|---|---|---|---|
| /Users/dmmac/Library/Mobile Documents/iCloud~md~obsidian/Documents/MyBrain/00-Projects/kdk-wordpress/content/articles/committee-minutes-three-year-retention.html | 2026-09-01 | 公開/予約版の本文、CTA、記事内根拠 | 検索成果、owner/physician approval |
| https://laws.e-gov.go.jp/law/347M50002000032 | 2026-09-01 | 記事内の主要な公的・一次根拠 | KIDUKIの商品適合、契約成果 |
...
- CTA or next action: 衛生委員会運用か証跡管理かを相談する
...
|---|---|---|---|---|---|
| High | 記事末CTA | 予約版は全記事共通CTAで、委員会運用と証跡管理の選択に対応しない | article-plan.json / service/sangyoui / service/cloud | Retainを主着地、CASETRAを副着地とするexact CTAへ修正 | accepted / repaired locally |
...
- Local artifact: `/Users/dmmac/Library/Mobile Documents/iCloud~md~obsidian/Documents/MyBrain/00-Projects/kdk-wordpress/content/articles/committee-minutes-three-year-retention.html`
...
- Schedule record: WordPress post 1852、2026-09-22 07:00 JST予約を確認
- Post-publication review record: 7d 2026-09-29T08:00:00+09:00（fovhvdf2cekcpj9a3b9hb6khh8）、28d 2026-10-20T08:20:00+09:00（8ndeeaujap7plv7np6cmlr8p4c）、90d 2026-12-21T08:50:00+09:00（umvcjr1669gqmtqnal9i5mvj60）。Google Calendar APIで2026-09-01に確認
- Published verification:
- Measurement source and period:
- Remaining gates: exact versionのowner/legal approval evidence、公開後のライブ確認、Search Consoleと契約測定
...
| 2026-09-01 | backlog | scheduled | WordPress post 1852、2026-09-22 07:00 JSTを確認。予約は承認証拠ではない |
