---
task_id: CT-20260901-kenko-keiei-sleep-measures
title: 健康経営の睡眠施策｜調査票に書ける取り組みをどう設計するか
...
- 健康経営の睡眠施策を研修実施だけで終わらせず、相談導線、勤務改善、評価を含む支援相談へつなぐ。

## Audience and action

- Audience: 健康経営度調査や睡眠施策を担当する人事・健康経営担当者
- Main question or job: 調査票に書くだけでなく、実務として継続する睡眠施策をどう設計するか
- Desired next action: `/service/komon/` で既存体制への継続支援を確認し、選任・定例業務が必要なら `/service/sangyoui/` へ進む
- Non-goals: 個人への診断・治療指示、効果保証、特定医療機関への誘導、検索語の機械的反復

## Project truth

- Canonical project guide: ../README.md
- Current product or service state: 既存体制への継続的な施策設計はKIDUKI Basic、選任・定例業務はKIDUKI Retain。非復職の単発研修は正式SKU・料金・履行条件が未確定のため契約導線に数えない。
- Approved terminology: 健康経営、睡眠施策、相談導線、勤務改善、効果確認
...
- CTA or next action: 自社の睡眠施策の設計範囲を相談する
...
- Local artifact: `/Users/dmmac/Library/Mobile Documents/iCloud~md~obsidian/Documents/MyBrain/00-Projects/kdk-wordpress/content/articles/kenko-keiei-sleep-measures.html`
...
| 2026-09-01 | backlog | scheduled | WordPress post 1848、2026-09-15 07:00 JSTを確認。予約は承認証拠ではない |
