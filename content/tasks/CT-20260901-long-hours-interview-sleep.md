---
task_id: CT-20260901-long-hours-interview-sleep
title: 長時間労働者の面接指導で睡眠を診る｜80時間超の面談を形式で終わらせない
...
draft_reference: /Users/dmmac/Library/Mobile Documents/iCloud~md~obsidian/Documents/MyBrain/00-Projects/kdk-wordpress/content/articles/long-hours-interview-sleep.html
exact_version: 2026-09-01-v6
exact_version_sha256: 310a8afc967a196219d7667f8ddd11313287076dcd046594fcf08b5aa7ae4c9a
...
- 長時間労働者の面接指導を形式的な面談で終わらせず、会社の措置と再評価を含む継続契約へつなぐ。

## Audience and action

- Audience: 長時間労働者対応を行う企業の人事・労務・衛生管理者
- Main question or job: 80時間超の面接指導で睡眠をどう確認し、面談後の措置へ落とすか
- Desired next action: 法定・定例業務を含む場合は `/service/sangyoui/`、既存体制への補完は `/service/komon/` へ進む
- Non-goals: 個人への診断・治療指示、効果保証、特定医療機関への誘導、検索語の機械的反復

## Project truth

- Canonical project guide: ../README.md
- Current product or service state: 選任・定例業務はKIDUKI Retain、既存産業医を維持した専門補完はKIDUKI Basic。
- Approved terminology: 面接指導、睡眠、会社措置、再評価、法定業務
...
|---|---|---|---|
| /Users/dmmac/Library/Mobile Documents/iCloud~md~obsidian/Documents/MyBrain/00-Projects/kdk-wordpress/content/articles/long-hours-interview-sleep.html | 2026-09-01 | 公開/予約版の本文、CTA、記事内根拠 | 検索成果、owner/physician approval |
...
- CTA or next action: 法定・定例業務か既存体制への補完かを相談する
...
|---|---|---|---|---|---|
| High | 記事末CTA | 予約版は全記事共通CTAで、法定・定例業務と専門補完を選べない | article-plan.json / service/sangyoui / service/komon | Retainを主着地、Basicを副着地とするexact CTAへ修正 | accepted / repaired locally |
...
- Local artifact: `/Users/dmmac/Library/Mobile Documents/iCloud~md~obsidian/Documents/MyBrain/00-Projects/kdk-wordpress/content/articles/long-hours-interview-sleep.html`
...
- Schedule record: WordPress post 1846、2026-09-11 07:00 JST予約を確認
- Post-publication review record: 7d 2026-09-18T08:00:00+09:00（7p2rid8j691rpl8jp4ra91aj6g）、28d 2026-10-09T08:20:00+09:00（ou61t4u2hoedi5v94vrg8hffps）、90d 2026-12-10T08:50:00+09:00（l4d81nlga2g7chundoq9qt0t78）。Google Calendar APIで2026-09-01に確認
...
| 2026-09-01 | backlog | scheduled | WordPress post 1846、2026-09-11 07:00 JSTを確認。予約は承認証拠ではない |
