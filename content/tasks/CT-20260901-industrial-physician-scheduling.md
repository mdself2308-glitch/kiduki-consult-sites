---
task_id: CT-20260901-industrial-physician-scheduling
title: 産業医面談の日程調整が終わらない理由と、決めておくべき3つのこと
...
draft_reference: /Users/dmmac/Library/Mobile Documents/iCloud~md~obsidian/Documents/MyBrain/00-Projects/kdk-wordpress/content/articles/industrial-physician-scheduling.html
exact_version: 2026-09-01-v6
exact_version_sha256: f0c203a57966b9b955774bb9a00652c51a04f0fbfb29c2ae99880105a0fbf5f7
...
- 産業医面談の日程調整の停滞を、CASETRAによる案件・資料・期限管理の相談へつなぐ。

## Audience and action

- Audience: 産業医面談の日程調整と資料回収を担う人事・労務担当者
- Main question or job: 候補日時、必要資料、確定責任者をどう仕組み化するか
- Desired next action: 自社運用のDXは `/service/cloud/`、業務委託を含む場合は `/service/sangyoui/` へ進む
- Non-goals: 個人への診断・治療指示、効果保証、特定医療機関への誘導、検索語の機械的反復

## Project truth

- Canonical project guide: ../README.md
- Current product or service state: 自社の人事・既存産業医で運用する企業はCASETRA、選任・定例業務も必要ならRetain。
- Approved terminology: 日程調整、必要資料、確定責任者、案件管理、期限
...
|---|---|---|---|
| /Users/dmmac/Library/Mobile Documents/iCloud~md~obsidian/Documents/MyBrain/00-Projects/kdk-wordpress/content/articles/industrial-physician-scheduling.html | 2026-09-01 | 公開/予約版の本文、CTA、記事内根拠 | 検索成果、owner/physician approval |
...
- CTA or next action: 自社運用DXか産業医業務委託かを相談する
...
|---|---|---|---|---|---|
| High | 記事末CTA | 予約版は全記事共通CTAで、自社運用DXと委託を選べない | article-plan.json / service/cloud / service/sangyoui | CASETRAを主着地、Retainを副着地とするexact CTAへ修正 | accepted / repaired locally |
...
- Local artifact: `/Users/dmmac/Library/Mobile Documents/iCloud~md~obsidian/Documents/MyBrain/00-Projects/kdk-wordpress/content/articles/industrial-physician-scheduling.html`
...
- Schedule record: WordPress post 1854、2026-09-25 07:00 JST予約を確認
- Post-publication review record: 7d 2026-10-02T08:00:00+09:00（r0ecqmjkfqondmqgpv29oane34）、28d 2026-10-23T08:20:00+09:00（lfbr9rhu3oh7v3cj1fkvdrf4ac）、90d 2026-12-24T08:50:00+09:00（4u3hpn9mmlie11iim4cb2a1e4c）。Google Calendar APIで2026-09-01に確認
...
| 2026-09-01 | backlog | scheduled | WordPress post 1854、2026-09-25 07:00 JSTを確認。予約は承認証拠ではない |
