...
<label>ご相談内容の種別(必須)
[select* inquiry-type "睡眠に特化した産業医の継続契約を相談したい" "産業衛生業務のDX・Casetra利用を相談したい" "既存の産業医体制に睡眠の専門支援を加えたい" "睡眠研修・健康経営施策を相談したい" "復職支援・判定面談を1件から相談したい" "夜勤・運転・SASなど睡眠課題を相談したい" "講演・執筆・取材の依頼" "その他"]</label>
